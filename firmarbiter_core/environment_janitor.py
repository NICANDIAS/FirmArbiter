...
def _container_is_owned(
    ...
    return (
        labels.get("firmarbiter.managed") == "true"
        and labels.get("firmarbiter.run_id") == run_id
    )
...
def build_remediation_plan(
    *,
    ...
    Only resources with independently verifiable FIRMARBITER ownership are
        ...
        if owned:
            actions.append(
                RemediationAction(
                    ...
                    authorised=True,
                    reason=(
                        "Container has the FIRMARBITER managed label "
            ...
            if not _container_is_owned(
                ...
                results.append(
                    RemediationActionResult(
                        ...
                        status="preserved",
                        reason=(
                            "FIRMARBITER ownership labels were absent "
