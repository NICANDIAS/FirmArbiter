...
from firmarbiter_core.docker_namespace_probe import (
...
class RunCoordinatorError(RuntimeError):
    """Raised when a neutral FIRMARBITER run cannot be prepared."""
        ...
        *,
        ...
        if run_directory.exists():
            raise RunCoordinatorError(
                ...
                f"{run_directory}. "
                "FIRMARBITER will not mix historical and new results."
            )
        ...
        request = {
            ...
            "paths": {
                ...
                "events": (
                    "/firmarbiter/events/events.jsonl"
                ),
