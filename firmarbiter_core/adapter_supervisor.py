...
class AdapterProcessSupervisor:
    ...
    def start(self) -> None:
        ...
        # Test-only host mapping for fixed /firmarbiter contract paths.
        # Real adapters will see /firmarbiter directly inside their container.
        environment["FIRMARBITER_CONTRACT_ROOT"] = str(
            self.contract_root
        )
